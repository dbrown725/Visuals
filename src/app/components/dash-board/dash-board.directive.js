...
(function() {
  ...
  function dashBoard() {
    return {
      restrict: 'E',
      replace: true,
      templateUrl: 'app/components/dash-board/dash-board.directive.html',
      scope: {},
      link: link
    };
    ...
    function link() {
      ...
      //Based on d3 v3 http://bl.ocks.org/NPashaP/96447623ef4d342ee09b
      //With d3 v4 conversion help from https://bl.ocks.org/d3noob/bdf28027e0ce70bd132edc64f1dd7ea4
      function svgDashboard(id, fData) {
        ...
        function histoGram(fD) {
          ...
          hGDim.w = (500 - hGDim.l - hGDim.r),
            hGDim.h = (300 - hGDim.t - hGDim.b); // jshint ignore:line
          ...
          //var x = d3.scaleOrdinal().rangeRoundBands([0, hGDim.w], 0.1)
          ...
          function mouseout(d) { //jshint unused:false
      ...
      svgDashboard('#dashboard', freqData);
    }
