...
(function() {
  ...
  angular
    .module('Visuals')
    .directive('dashBoard2', dashBoard2);

  //Based on http://bl.ocks.org/diethardsteiner/3287802
  // Migrated from d3 v2 to d3 v4
  function dashBoard2() {
    return {
      restrict: 'E',
      replace: true,
      templateUrl: 'app/components/dash-board-2/dash-board-2.directive.html',
      scope: {},
      link: link
    };
      ...
      function dsBarChart() {
        ...
        plot.selectAll('text')
          ...
          .text(function(d) {
            ...
            return formatAsInteger(d3.format('d')(d.measure));
          })
          .attr('text-anchor', 'middle')
